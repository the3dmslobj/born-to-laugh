    ...
    if (result.size === 0) {
        ...
        for(let i=0; i < allPosts.length; i++) {
            ...
            firebase.firestore().collection('users/').doc(allPosts[i].uid).get().then((res) => {
                ...
                moreButtonContainer.classList.add('post-more-container');
                ...
                moreButton.setAttribute('class', 'post-more-button');

                let dleDiv = document.createElement('div');
                dleDiv.setAttribute('class', 'post-dle-div');

                let dleIcon = document.createElement('ion-icon');
                dleIcon.setAttribute('class', 'post-dle-icon');
                dleIcon.setAttribute('name', "trash-bin-outline");
                dleDiv.appendChild(dleIcon);

                let dleText = document.createElement('div');
                dleText.innerHTML = 'Delete';
                dleText.setAttribute('class', 'post-dle-text');
                dleDiv.appendChild(dleText);
                ...
                let moreIcon = document.createElement('ion-icon');
                moreIcon.setAttribute('class', 'post-dle-icon');
                moreIcon.setAttribute('name', 'ellipsis-vertical-outline')
                ...
                footerDiv.appendChild(moreButtonContainer);
                moreButtonContainer.appendChild(dleDiv);
                ...
                let writeComment = document.createElement('div');
                        ...
                        moreButtonContainer.addEventListener('click', () => {
                            if(dleDiv.style.transform === 'scaleX(0)') {
                                dleDiv.style.transform = 'scaleX(1)';
                            } else {
                                dleDiv.style.transform = 'scaleX(0)';
                            }
                        })
